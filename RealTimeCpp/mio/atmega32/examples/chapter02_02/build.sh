...
$TOOL_PATH/$TOOL_PREFIX-g++ -mmcu=atmega32 -fsigned-char -x assembler crt0.s -c -o bin/crt0.o

echo "Compile  : led.cpp to bin/led.o"
$TOOL_PATH/$TOOL_PREFIX-g++ -mmcu=atmega32 -fsigned-char -O2 -std=c++0x -I. -c led.cpp -o bin/led.o

echo "Link     : objects to bin/led.elf"
$TOOL_PATH/$TOOL_PREFIX-g++ -mmcu=atmega32 -nostartfiles -nostdlib -Wl,-Tavr.ld,-Map,bin/led.map bin/led.o bin/crt0.o -o bin/led.elf
